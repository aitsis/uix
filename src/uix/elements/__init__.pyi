...
'''
    def __init__(self,id:str = None, value = None, width: int= 300, height: int = 150)-> None: ...
...
'''
    def __init__(self,value:str,id:str = None, media:str = None,type:str ="video/mp4")-> None: ...
...
'''
    def __init__(self,value:str = None, id:str = None,name:str = None)-> None: ...
...
'''
    def __init__(self,value:str = None,id:str = None, disabled:bool=False)-> None: ...
...
'''
    def __init__(self,value:str,id:str = None)-> None: ...
...
'''
    def __init__(self,value:str= None, id:str = None)-> None: ...
from uix.elements._embed import _embed
class embed(Element):
    '''
...
'''
    def __init__(self, value:str=None, id:str=None, type:str=None, width:str=None, height:str=None)-> None: ...
...
'''
    def __init__(self,value:str,id:str = None, type:str='button', formID:str=None, disabled:bool=False)-> None: ...
...
"""
    def __init__(self, value: str=None, id:str =None, multiple:bool = False, callback = None, accept:bool = False)-> None: ...
...
'''
    def __init__(self,value:str = None, id:str = None, role:str = None)-> None: ...
...
"""
    def __init__(self, value:str=None, id:str=None, min:int=0, max:int=100, step:int=1,)-> None: ...
...
"""
    def __init__(self, value:str = None, id:str = None,loop: bool=True, autoplay: bool=True, muted: bool=True, src:str=None)-> None: ...
...
'''
    def __init__(self,value:str = None,id:str = None, close_on_outside:bool = True)-> None: ...
...
'''
    def __init__(self,value:str= None,id:str = None, tabindex:int = -1, usefor:str = None)-> None: ...
...
'''
    def __init__(self,value:str = None,id:str = None,type: str='text',name:str=None,placeholder:str="",required:bool=False,list:str=None)-> None: ...
...
"""
    def __init__(self,value:str = 0,id:str = None, max:int = 100)-> None: ...
...
'''
    def __init__(self,value: str,id:str = None, columns:str = None, rows:str = None)-> None: ...
